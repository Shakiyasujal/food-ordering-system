    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            const res = await axios.post(
                'https://food-ordering-system-backend-qlrh.onrender.com/api/items',
                payload,
                {
                    headers: {
                    ...
                    <form className='space-y-6 sm:space-y-8' onSubmit={handleSubmit}>
                        ...
                        <div className='space-y-6'>
                            ...
                            <textarea name='description' value={formData.description}
                                onChange={handleInputChange} placeholder='Enter Product Description'
                                className={styles.inputField + 'h-32 sm:h-40'} required></textarea>
                        </div>
                                            ...
                                            <button key={star} type='button' onClick={() => handleRating(star)}
                                                ...
                                                <FiStar className={
                                                    star <= (hoverRating || formData.rating)
                                                        ? 'text-amber-400 fill-current' : 'text-amber-100/30'
                                                } />
                                            </button>
                                        ))}
                                    </div>
