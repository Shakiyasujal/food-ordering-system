...
export const CartProvider = ({ children }) => {
    ...
    useEffect(() => {
        ...
        axios.get('https://food-ordering-system-backend-qlrh.onrender.com/api/cart', {
    ...
    const addToCart = useCallback(async (item, qty) => {
        ...
        const res = await axios.post(
            'https://food-ordering-system-backend-qlrh.onrender.com/api/cart',
    ...
    const removeFromCart = useCallback(async (_id) => {
        const token = localStorage.getItem('authToken')
        await axios.delete(`https://food-ordering-system-backend-qlrh.onrender.com/api/cart/${_id}`, {
            withCredentials: true,
            headers: { Authorization: `Bearer ${token}` }
        })
    ...
    const updateQuantity = useCallback(async (_id, qty) => {
        ...
        const res = await axios.put(
            `https://food-ordering-system-backend-qlrh.onrender.com/api/cart/${_id}`,
            { quantity: qty },
            {
                withCredentials: true,
                headers: { Authorization: `Bearer ${token}` }
    ...
    const clearCart = useCallback(async () => {
        const token = localStorage.getItem('authToken')
        await axios.post(
            'https://food-ordering-system-backend-qlrh.onrender.com/api/cart/clear',
            {},
            {
                withCredentials: true,
                headers: { Authorization: `Bearer ${token}` }
