...
const SpecialOffer = () => {
    ...
    //fetch menu
    useEffect(() => {
        axios.get('https://food-ordering-system-backend-0o7i.onrender.com/api/items').then(res => setItems(res.data.items ?? res.data))
    ...
    return (
        <div className='bg-gradient-to-br from-[#1f1414] via-[#2a1e1e] to-[#3a2a2a] text-white py-16 px-4 font-[Poppins]'>
                    ...
                    {displayList.map(item => {
                        ...
                        return (
                            ...
                            before:inset-0 hover:before:opacity-20'>
                                ...
                                <div className='relative h-72 overflow-x-hidden'>
                                    <img
                                        src={item.imageUrl}
                                        alt={item.name}
                                    ...
                                    <div className='absolute inset-0 bg-gradient-to-b from-transparent via-trasparent to-black/90' />
                                    <div className='absolute bottom-4 left-4 right-4 flex justify-between items-center bg-black/40 backdrop-blur-sm px-4
                                    py-2 rounded-full'>
