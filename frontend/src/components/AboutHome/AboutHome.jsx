...
const AboutHome = () => {
    return (
        ...
        py-10 sm:py-20 relative overflow-hidden'>
            ...
            xl:gap-16 relative'>
                <div className='w-full order-1 lg:order-2 space-y-8 sm:space-y12 realtive'>
                    <div className='space-y-4 sm:space-y-8 px-4 sm:px-0'>
                        <h2 className='text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-bold leading-tight'>
                            <span className='font-cursive text-4xl sm:text-5xl md:text-6xl bg-gradient-to-r from-amber-400 to-orange-500
                        ...
                        <p className='text-bas sm:text-lg md:text-xl opacity-90 leading-relaxed max-w-3xl font-serif
                        italic border-1-4 bg-amber-400/60 pl-4 sm:pl-6 py-2 bg-gradient-to-r from-white/5 to-transparent'>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 px-4 sm:px-0'>
                        {aboutfeature.map((item, i) => (
                            ...
                            duration-300 p-4 sm:p-5 hover:translate-x-2'>
                                <div className={`p-4 sm:p-4 rounded-full bg-gradient-to-br ${item.color}
                    ...
                    <div className='flex flex-wrap gap-4 items-center mt-6 sm:mt-8 px-4 sm:px-0'>
                        ...
                        shadow-xl hover:shadow-amber-500/20 group relative overflow-hidden' >
                            ...
                            <span className='font-cursive text-lg sm:text-xl'>Unviel Our legacy</span>
                        </Link>
                    </div>
                </div>
                ...
                group transform hover:scale-[1.01] transition-all duration-500'>
                    ...
                    duration-500 shadow-2xl shadow-black/50'>
                        ...
                        <img src={AboutImage} alt='Resturant' className='w-full h-auto object-cover aspect-[3/4] transform
